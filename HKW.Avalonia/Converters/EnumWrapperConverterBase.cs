...
public abstract class EnumWrapperConverterBase<TConverter> : ValueConverterBase<TConverter>
    where TConverter : EnumWrapperConverterBase<TConverter>, new()
{
    ...
    )
    {
        ...
        if (value is IEnumerable)
        {
            ...
            throw new ArgumentException(
                "EnumWrapperConverter cannot convert non-generic IEnumerable. Please bind an IEnumerable<T>."
            );
        }
    ...
    )
    {
        ...
        if (targetType == null)
        {
            throw new ArgumentNullException(
                nameof(targetType),
                "Argument 'targetType' must not be null"
            );
        }
        ...
        {
            Debug.WriteLine(
                "EnumWrapperConverter was used to convert between equal types. Consider removing it in this particular situation."
            );
            return value;
        }
        ...
        if (
            ...
            && type.GetGenericArguments()[0] == targetType
        )
        {
    ...
    public EnumWrapper<T> CreateMapper<T>(
        object? value,
    ...
    public IEnumerable<EnumWrapper<T>> CreateMapperList<T>(
        object values,
        EnumWrapperConverterNameStyle nameStyle = EnumWrapperConverterNameStyle.LongName
    )
    {
